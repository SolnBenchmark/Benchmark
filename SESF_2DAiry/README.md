# SESF_2DAiry: Single Emitter Single Frame 2D Airy PSF
...
**SESF_2DAiry_highSNR_Frame.tif (For purpose of demonstration, .png images are shown here.)**

![Alt text](SESF_2DAiry_highSNR_Frame.png)

**SESF_2DAiry_mediumSNR_Frame.tif**

![Alt text](SESF_2DAiry_mediumSNR_Frame.png)

**SESF_2DAiry_lowSNR_Frame.tif**

![Alt text](SESF_2DAiry_lowSNR_Frame.png)
...
**SESF_2DAiry_highSNR_xy_algorithmName.txt** 

**SESF_2DAiry_mediumSNR_xy_algorithmName.txt**

**SESF_2DAiry_lowSNR_xy_algorithmName.txt**.
