# 2DGauss_MEMF_MTR: 2D Gaussian PSF Multiple Emitter Multiple Frame Median Temporal Resolution 

## Purpose 
Evaluate and benchmark performance of localization algorithms in localization of multiple emitters from a data movie of multiple frames with low temporal resolution (5 seconds). 
...
**2DGauss_MEMF_MTR_eD40nm_movie.zip  (For purpose of demonstration, .png images of the 10th frames are shown here.)**

![Alt text](Doc/2DGauss_MEMF_MTR_eD40nm_Frame10.png)

**2DGauss_MEMF_MTR_eD30nm_movie.zip**

![Alt text](Doc/2DGauss_MEMF_MTR_eD30nm_Frame10.png)

**2DGauss_MEMF_MTR_eD20nm_movie.zip**

![Alt text](Doc/2DGauss_MEMF_MTR_eD20nm_Frame10.png)
...
**2DGauss_MEMF_MTR_eD40nm_xy_algorithmName.txt** 

**2DGauss_MEMF_MTR_eD30nm_xy_algorithmName.txt** 

**2DGauss_MEMF_MTR_eD20nm_xy_algorithmName.txt** 
...
|:-----|:-----|:-----|
|2DGauss_MEMF_MTR_eD40nm_movie.zip |40|nm|
|2DGauss_MEMF_MTR_eD30nm_movie.zip |30|nm|
|2DGauss_MEMF_MTR_eD20nm_movie.zip |20|nm|
