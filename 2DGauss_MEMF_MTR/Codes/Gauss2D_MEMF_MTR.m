...
%% Intialization 
rng('default') ; 
key=433901 ;          % key for random number generators
key=key+eD ; 
rng(key) ; 
...
p0=1/den ;        % =0.9760, probability of de-activation
...
% Average RMSMD-M: mean([3.24  3.16  3.10])
% Average RMSMD-F: mean([11.22 12.30 18.66])
