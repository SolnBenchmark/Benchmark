# SESF_2DGauss: Single Emitter Single Frame 2D Gaussian PSF
...
**SESF_2DGauss_highSNR_Frame.tif (For purpose of demonstration, .png images are shown here.)**

![Alt text](SESF_2DGauss_highSNR_Frame.png)

**SESF_2DGauss_mediumSNR_Frame.tif**

![Alt text](SESF_2DGauss_mediumSNR_Frame.png)

**SESF_2DGauss_lowSNR_Frame.tif**

![Alt text](SESF_2DGauss_lowSNR_Frame.png)
...
**SESF_2DGauss_highSNR_xy_algorithmName.txt** 

**SESF_2DGauss_mediumSNR_xy_algorithmName.txt**

**SESF_2DGauss_lowSNR_xy_algorithmName.txt**
...
|:-----|:-----|:-----|:-----|
|**SESF_2DGauss_highSNR_Frame.tif**|Mean of Poisson noise |b=0.5|photons/s/nm<sup>2</sup>|
...
| |                           |SNR=54.77|dB|
|**SESF_2DGauss_mediumSNR_Frame.tif**|Mean of Poisson noise |b=15|photons/s/nm<sup>2</sup>|
...
| |                           |SNR=40.79|dB|
|**SESF_2DGauss_lowSNR_Frame.tif**|Mean of Poisson noise |b=30|photons/s/nm<sup>2</sup>|
