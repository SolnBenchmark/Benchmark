...
U16=uint16(U) ; 
filename_Frame=strcat('SESF2DGauss_',SNRr,'_Frame','.tif') ; 
...
filename_Frame=strcat('SESF2DGauss_',SNRr,'_Frame','.png') ; 
...
[SDV,SDVavg,SDV_FWHM,SDV_FWHMavg,F_]=CRLB_2DGauss(sigma,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xy) ;
