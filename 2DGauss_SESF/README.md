...
![Alt text](2DGauss_SESF_highSNR_Frame.png)

**2DGauss_SESF_mediumSNR_Frame.tif**

![Alt text](2DGauss_SESF_mediumSNR_Frame.png)

**2DGauss_SESF_lowSNR_Frame.tif**

![Alt text](2DGauss_SESF_lowSNR_Frame.png)
...
|:-----|:-----|:-----|:-----|
|**2DGauss_SESF_highSNR_Frame.tif**|Mean of Poisson noise |b=0.5|photons/s/nm<sup>2</sup>|
...
| |                           |SNR=54.77|dB|
|**2DGauss_SESF_mediumSNR_Frame.tif**|Mean of Poisson noise |b=15|photons/s/nm<sup>2</sup>|
...
| |                           |SNR=40.79|dB|
|**2DGauss_SESF_lowSNR_Frame.tif**|Mean of Poisson noise |b=30|photons/s/nm<sup>2</sup>|
