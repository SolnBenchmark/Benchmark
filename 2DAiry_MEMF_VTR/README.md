# 2DAiry_MEMF_VTR: 2D Airy PSF Multiple Emitter Multiple Frame Very High Temporal Resolution 
...
**2DAiry_MEMF_VTR_eD40nm_movie.zip  (For purpose of demonstration, .png images of the 10th frames are shown here.)**

![Alt text](Doc/2DAiry_MEMF_VTR_eD40nm_Frame10.png)

**2DAiry_MEMF_VTR_eD30nm_movie.zip**

![Alt text](Doc/2DAiry_MEMF_VTR_eD30nm_Frame10.png)

**2DAiry_MEMF_VTR_eD20nm_movie.zip**

![Alt text](Doc/2DAiry_MEMF_VTR_eD20nm_Frame10.png)
...
**2DAiry_MEMF_VTR_eD40nm_xy_algorithmName.txt** 

**2DAiry_MEMF_VTR_eD30nm_xy_algorithmName.txt** 

**2DAiry_MEMF_VTR_eD20nm_xy_algorithmName.txt** 
...
|:-----|:-----|:-----|
|2DAiry_MEMF_VTR_eD40nm_movie.zip |40|nm|
|2DAiry_MEMF_VTR_eD30nm_movie.zip |30|nm|
|2DAiry_MEMF_VTR_eD20nm_movie.zip |20|nm|
