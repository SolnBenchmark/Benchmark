...
%% Intialization 
rng('default') ; 
key=432900 ;          % key for random number generators
switch eD
  case 40
    key=key+0 ; 
  case 30
...
N=500 ;         % corresponding Nape=N*(1-p0)=9.8808
...
% Average RMSMD-M: mean([3.39  3.41  3.63])=3.48 (nm) 
% Average RMSMD-F: mean([10.69 11.78 13.99])=12.15 (nm)
