%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SolnBenchmark: Gauss2D_MEMF_LTR 
% (1) Gaussian - PSF
...
filename_Frame=strcat('2DGauss_MEMF_LTR_eD',num2str(eD),'nm_Frame',num2str(10),'.tif') ;
...
filename_Frame=strcat('2DGauss_MEMF_LTR_eD',num2str(eD),'nm_Frame',num2str(10),'.png') ;
...
% Average RMSMD-M: mean([3.06  2.89  2.85])
% Average RMSMD-F: mean([10.53 10.55 13.46])
