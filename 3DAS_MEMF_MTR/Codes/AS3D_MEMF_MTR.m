...
% 03/07/2020, 04/07/2020/, 05/08/2020
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
filename_xyz0=strcat('3DAS_MEMF_MTR_eD',num2str(eD),'nm_xyz0','.txt') ; 
...
pd=1-(1-p0^N)^M ;         % =2.6504e-3, probability that at least one emitter 
...
for n=1:N
  ...
  U16=uint16(U) ;
  filename_Frame=strcat('3DAS_MEMF_MTR_eD',num2str(eD),'nm_Frame',num2str(n),'.tif') ;
...
filename_Frame=strcat('3DAS_MEMF_MTR_eD',num2str(eD),'nm_Frame',num2str(10),'.tif') ;
...
filename_Frame=strcat('3DAS_MEMF_MTR_eD',num2str(eD),'nm_Frame',num2str(10),'.png') ;
...
% pM:           500   500   500
% UGIA-M (nm):  1.64  1.78  2.91  2.11
% UGIA-F (nm):  50.57 68.82 97.21 72.20
% mean([1.64  1.78  2.91]) 
