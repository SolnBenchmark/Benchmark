%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SolnBenchmark: Gauss2D_MEMF_HTR 
% (1) Gaussian - PSF
...
filename_xy0=strcat('2DGauss_MEMF_HTR_eD',num2str(eD),'nm_xy0','.txt') ; 
...
for n=1:N
  ...
  U16=uint16(U) ;
  filename_Frame=strcat('2DGauss_MEMF_HTR_eD',num2str(eD),'nm_Frame',num2str(n),'.tif') ;
...
filename_Frame=strcat('2DGauss_MEMF_HTR_eD',num2str(eD),'nm_Frame',num2str(10),'.tif') ;
...
filename_Frame=strcat('2DGauss_MEMF_HTR_eD',num2str(eD),'nm_Frame',num2str(10),'.png') ;
...
% pM:           500   500   500
% UGIA-M (nm):  3.35  3.64  4.15    3.71
% UGIA-F (nm):  55.46 95.30 217.64  122.80
% mean([3.35  3.64  4.15]) 
