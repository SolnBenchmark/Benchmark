...
filename_xy0=strcat('MESF2DGauss_density',num2str(eDen),'_xy0','.txt') ; 
...
U16=uint16(U) ; 
filename_Frame=strcat('MESF2DGauss_density',num2str(eDen),'_Frame','.tif') ; 
...
filename_Frame=strcat('MESF2DGauss_density',num2str(eDen),'_Frame','.png') ; 
