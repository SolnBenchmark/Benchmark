...
% F_      - inverse of Fisher information matrix F
%
...
function [SDV,SDVavg,FWHM,FWHMavg,F_]=CRLB_2DAiry(na,lambda,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xy)
...
a=2*pi*na/lambda ; 
d=20 ;	% As d increase, computation time decreases but error increases
