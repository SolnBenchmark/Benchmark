...
function [xyzF,F,F_]=UGIA_F_3DAS(c,d,sigmax0,Ax,Bx,sigmay0,Ay,By,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xyz) 
...
F=Fisher_3DAS(c,d,sigmax0,Ax,Bx,sigmay0,Ay,By,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xyz) ;
F_=pinv(F) ;
% UGIA-F estimator
xyzF=zeros(3,M) ; 
[U,L,~]=svd(F_) ;
