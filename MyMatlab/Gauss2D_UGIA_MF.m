...
% matrices with a 2D Gaussian PSF. 
% 
% Input:
...
function [xyM,xyF,FF,FF_]=Gauss2D_UGIA_MF(sigma,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xy,a) 
...
for n=1:N
  ...
  if Na(n)==0           % no activated emitter in frame n
    ...
    F=Gauss2D_Fisher(sigma,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xyA(:,1:p)) ;
