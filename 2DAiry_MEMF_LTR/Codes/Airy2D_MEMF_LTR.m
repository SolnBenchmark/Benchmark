...
% 02/26/2020, 04/05/2020, 05/07/2020, 12/18/2020
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
filename_xy0=strcat('2DAiry_MEMF_LTR_eD',num2str(eD),'nm_xy0','.txt') ; 
...
p0=1/den ;                % =0.9880, probability of deactivation, i.e. state 0
p1=r10/den ;              % =0.0071, probability of state 1
p2=r10*r21/den ;          % =0.0036, probability of state 2
...
pd=1-(1-p0^N)^M ;         % =2.8530e-03, probability that at least one emitter 
...
for n=1:N
  ...
  U16=uint16(U) ;
  filename_Frame=strcat('2DAiry_MEMF_LTR_eD',num2str(eD),'nm_Frame',num2str(n),'.tif') ;
...
filename_Frame=strcat('2DAiry_MEMF_LTR_eD',num2str(eD),'nm_Frame',num2str(10),'.tif') ;
...
filename_Frame=strcat('2DAiry_MEMF_LTR_eD',num2str(eD),'nm_Frame',num2str(10),'.png') ;
...
% M=500; N=1000; TR=10 sec
% pM: # emitters activated at least once in a movie
% Distance:     40    30    20    Average (nm)
% pM:           500   500   500
% UGIA-M (nm):  2.56  2.58  2.77  2.63
% UGIA-F (nm):  9.11  10.31 11.87 10.43
% mean([9.11  10.31 11.87]) 
