# 2DGauss_MEMF: 2D Gaussian PSF Multiple Emitter Multiple Frame 
...
**2DGauss_MEMF_eD40nm_movie.zip  (For purpose of demonstration, .png images of the 10th frames are shown here.)**

![Alt text](2DGauss_MEMF_eD40nm_Frame10.png)

**2DGauss_MEMF_eD30nm_movie.zip**

![Alt text](2DGauss_MEMF_eD30nm_Frame10.png)

**2DGauss_MEMF_eD20nm_movie.zip**

![Alt text](2DGauss_MEMF_eD20nm_Frame10.png)
...
**2DGauss_MEMF_eD40nm_xy_algorithmName.txt** 

**2DGauss_MEMF_eD30nm_xy_algorithmName.txt** 

**2DGauss_MEMF_eD20nm_xy_algorithmName.txt** 
...
|:-----|:-----|:-----|
|2DGauss_MEMF_eD40nm_movie.zip |40|nm|
|2DGauss_MEMF_eD30nm_movie.zip |30|nm|
|2DGauss_MEMF_eD20nm_movie.zip |20|nm|
