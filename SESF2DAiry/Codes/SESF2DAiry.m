...
lambda=520 ;          % nm
a=2*pi*na/lambda ; 
sigma=1.3238/a ;      % = 78.26 nm, SDV of Airy PSF
%% Frame 
...
filename_xy0=strcat('SESF2DAiry_',SNRr,'_xy0','.txt') ; 
...
U16=uint16(U) ; 
filename_Frame=strcat('SESF2DAiry_',SNRr,'_Frame','.tif') ; 
...
filename_Frame=strcat('SESF2DAiry_',SNRr,'_Frame','.png') ; 
...
[SDV,SDVavg,SDV_FWHM,SDV_FWHMavg,F_]=CRLB_2DAiry(na,lambda,Kx,Ky,Dx,Dy,Dt,Ih,b,G,xy) ;
...
% mediumSNR: SNR=40.79 (dB) M=961 RMSMD= 9.34 (nm)
% lowSNR:    SNR=37.78 (dB) M=961 RMSMD=13.07 (nm) 
% Average: mean([3.05 9.34 13.07])=8.49 (nm)
