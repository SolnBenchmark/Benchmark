...
filename_xy0=strcat('2DAiry_MEMF_STR_eD',num2str(eD),'nm_xy0','.txt') ; 
...
for n=1:N
  ...
  U16=uint16(U) ;
  filename_Frame=strcat('2DAiry_MEMF_STR_eD',num2str(eD),'nm_Frame',num2str(n),'.tif') ;
...
filename_Frame=strcat('2DAiry_MEMF_STR_eD',num2str(eD),'nm_Frame',num2str(10),'.tif') ;
...
filename_Frame=strcat('2DAiry_MEMF_STR_eD',num2str(eD),'nm_Frame',num2str(10),'.png') ;
...
% UGIA-F:         84.87 136.61  237.50  152.99
% mean([84.87 136.61  237.50])
