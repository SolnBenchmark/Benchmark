...
rp=Ih/b ;             % 180000
nup=beta*rp ; 
SPNR=10*log10(nup)    % 0.23 (dB)
rg=Ih/G ;             % 300000
nug=beta*rg ; 
SGNR=10*log10(nug)    % 2.45 (dB)
r=rp*rg/(rp+rg) ;     % 112500
nu=beta*r ; 
SNR=10*log10(nu)      % -1.81 (dB)
...
% pM:           498     497     495
% UGIA-M (nm):  4.44    5.18    10.86   6.82
% UGIA-F (nm):  157.18  202.84  369.39  243.14
% mean([4.44    5.18    10.86]) 
