...
filename_xy0=strcat('MEMF2DGauss_eD',num2str(eD),'nm_xy0','.txt') ; 
...
for n=1:N
  ...
  U16=uint16(U) ;
  filename_Frame=strcat('MEMF2DGauss_eD',num2str(eD),'nm_Frame',num2str(n),'.tif') ;
...
filename_Frame=strcat('MEMF2DGauss_eD',num2str(eD),'nm_Frame',num2str(10),'.tif') ;
...
filename_Frame=strcat('MEMF2DGauss_eD',num2str(eD),'nm_Frame',num2str(10),'.png') ;
